    ...
    public abstract class ExpressionVisitor {
        ...
        protected virtual Expression Visit(Expression exp)
        {
            ...
            switch (exp.NodeType)
            {
                ...
                case ExpressionType.UnaryPlus: return this.VisitUnary((UnaryExpression)exp);
                ...
                case ExpressionType.Power: return this.VisitBinary((BinaryExpression)exp);
                ...
                default: return this.VisitUnknown(exp);
            }
        }

        protected virtual Expression VisitUnknown(Expression expression) 
        {
            throw new LinqToWikipediaException(String.Format("Unhandled expression type: '{0}'", expression.NodeType));
        }
